...
class _$ResultImpl implements _Result {
  ...
  @override
  String toString() {
    return 'Result(msisdnId: $msisdnId, msisdn: $msisdn, name: $name, basePrice: $basePrice, salePrice: $salePrice, productId: $productId, variantId: $variantId, usimPrice: $usimPrice, esimPrice: $esimPrice)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, msisdnId, msisdn, name,
      basePrice, salePrice, productId, variantId, usimPrice, esimPrice);
...
abstract class _Result implements Result {
  factory _Result(
      ...
      @JsonKey(name: 'esim_price') final int? esimPrice}) = _$ResultImpl;
