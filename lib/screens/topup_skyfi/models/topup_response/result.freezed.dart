...
class _$ResultImpl implements _Result {
  ...
  @override
  String toString() {
    return 'Result(id: $id, value: $value, status: $status, networkId: $networkId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, value, status, networkId);
...
abstract class _Result implements Result {
  factory _Result(
      ...
      final int? value,
      final int? status,
      @JsonKey(name: 'network_id') final int? networkId}) = _$ResultImpl;
