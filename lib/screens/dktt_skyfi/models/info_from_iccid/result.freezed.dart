...
abstract class $ResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? iccid, String? imsi, String? msisdn});
}
...
class _$ResultImpl implements _Result {
  _$ResultImpl({this.iccid, this.imsi, this.msisdn});
  ...
  @override
  String toString() {
    return 'Result(iccid: $iccid, imsi: $imsi, msisdn: $msisdn)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, iccid, imsi, msisdn);
...
abstract class _Result implements Result {
  factory _Result(
      {final String? iccid,
      final String? imsi,
      final String? msisdn}) = _$ResultImpl;
