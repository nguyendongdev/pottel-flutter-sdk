...
class ScanNfcChipcardScreenNew extends StatefulWidget {
  const ScanNfcChipcardScreenNew({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ScanNfcChipcardScreenNewState createState() =>
      _ScanNfcChipcardScreenNewState();
}

class _ScanNfcChipcardScreenNewState extends State<ScanNfcChipcardScreenNew>
  ...
  // mrz data
  final _docNumber = TextEditingController(text: "093009672"); //093009672
  final _dob = TextEditingController(text: '11/01/1993'); // 11/01/1993
  final _doe = TextEditingController(text: "11/01/2033"); // 11/01/2033
