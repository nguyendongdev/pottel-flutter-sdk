...
class _$PaymentMethodImpl implements _PaymentMethod {
  ...
  @override
  String toString() {
    return 'PaymentMethod(requestId: $requestId, code: $code, message: $message, totalRecords: $totalRecords, result: $result, extra: $extra)';
  }
...
abstract class _PaymentMethod implements PaymentMethod {
  factory _PaymentMethod(
      ...
      final int? totalRecords,
      final Result? result,
      final dynamic extra}) = _$PaymentMethodImpl;
